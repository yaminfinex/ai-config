...
- Source: https://github.com/plannotator/effective-html (`skills/html/`)
...
- Gallery licence: Apache-2.0, Copyright 2026 Anthropic PBC (`references/html-effectiveness/LICENSE`).
