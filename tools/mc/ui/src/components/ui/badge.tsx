...
// Vendored, owned source. Upstream's dark: variants are stripped: they bind
// to the viewer's OS color scheme, but here the skin (data-theme) is the
// only thing that may select theme values (ARCHITECTURE.md §3).
