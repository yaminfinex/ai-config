...
func printHelp(stdout io.Writer) {
	lines := []string{
		...
		"after a herdr restart resolution refuses rather than mis-sends; target by guid or label instead.",
		...
		"an owner-free recovery; no user-facing label or synthetic sender is substituted.",
