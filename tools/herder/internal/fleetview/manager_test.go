...
func TestManagerEdgeStates(t *testing.T) {
	...
	cases := []struct {
		...
		{"reparented to a web identity with no record", agentstore.AgentView{Manager: "web-owner", ManagerAt: &at, Provenance: agentstore.Provenance{LauncherKind: "agent"}}, "web-owner", ManagerOperator},
		...
		{"ambiguous base name stays unknown", agentstore.AgentView{Manager: "dupe", Provenance: agentstore.Provenance{LauncherKind: "mirror"}}, "dupe", ManagerUnknown},
