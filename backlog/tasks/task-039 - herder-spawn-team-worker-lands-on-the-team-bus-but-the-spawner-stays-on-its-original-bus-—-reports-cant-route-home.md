...
---
RESOLVED BY DESIGN (spec ratification 2026-07-08, #6423): owner confirmed D5 — teams killed ('multiple hcom dirs will cause other issues'). No fix; the --team surface and HCOM_DIR-per-team construct are removed in wave C (removal sites surveyed on this ticket: hookcmd/template.go:7, orchestrate SKILL.md:44). Per-run traffic grouping moves to hcom tags.
---
<!-- COMMENTS:END -->
