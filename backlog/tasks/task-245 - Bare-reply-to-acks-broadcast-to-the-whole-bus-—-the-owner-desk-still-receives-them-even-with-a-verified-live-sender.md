...
**Teardown reconciliation — 2026-08-24:** Remains open as an hcom reply-routing
defect. The herder prompt remedy below is retired; bootstrap doctrine now
requires explicit addressees, while the upstream bare-`--reply-to` behavior
