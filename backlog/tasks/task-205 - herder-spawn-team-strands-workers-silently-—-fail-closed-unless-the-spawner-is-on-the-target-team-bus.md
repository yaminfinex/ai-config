...
<!-- COMMENTS:BEGIN -->
created: 2026-07-15 00:15
---
SUPERSEDED BY REMOVAL: herder no longer accepts the per-team spawn flag, reads its former ambient
environment setting, constructs per-team bus directories, or advertises team-bus spawning. The
original incident remains here as provenance; the enforced remedy is the single global bus.
---
<!-- COMMENTS:END -->
