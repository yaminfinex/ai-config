...
---
Upgrade EXECUTED 2026-07-08 per the audit sequence: TASK-040 merged -> pin bumped (af9954b) -> ai-setup --shims install -> stale installs removed -> live tagged smoke PASSED. Machine is on 0.7.23. Gotcha discovered + documented: running sessions keep pre-upgrade PATH; after mise uninstall of the old version their herder shim finds no real hcom and degrades SILENTLY — fix is prepending ~/.local/share/mise/shims to PATH or restarting the session. Runbook: docs/hcom-upgrade.md.
---
<!-- COMMENTS:END -->
