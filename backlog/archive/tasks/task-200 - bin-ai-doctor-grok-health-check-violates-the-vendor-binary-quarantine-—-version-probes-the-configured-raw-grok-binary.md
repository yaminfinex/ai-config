...
<!-- SECTION:NOTES:BEGIN -->
PREMISE DISSOLVED by owner default-homes ruling 2026-07-14 (standing-orders 20.8): the ~/.grok preservation regime is retired, so the vendor-binary quarantine this capture enforces no longer exists. DO NOT DISPATCH as filed. Residual value (a default ai-doctor run should report agent binaries without surprising side effects) is folded into the grok managed-home dissolution task as a line item.
<!-- SECTION:NOTES:END -->
